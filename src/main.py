...
from schema_processor import ContentProcessor, ProcessingResult, ContentType
...
def process_directory(source_dir: Union[str, Path], output_dir: Union[str, Path]) -> Dict[str, List[ProcessingResult]]:
...
def main():
    ...
    try:
        ...
        for content_type, type_results in results.items():
            ...
            logger.info(f"{content_type}: Processed {total_count} files, {valid_count} valid")
